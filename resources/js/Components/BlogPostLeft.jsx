...
function BlogPostLeft({ title, description }) {
    return (
        <div className="w-full">
            <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-[38px] max-w-[1160px]">
                ...
                <div className="lg:col-span-5 flex flex-col justify-end relative pb-8 order-1 lg:order-2">
                    <motion.div
                        initial={{ width: 0 }}
                        whileInView={{ width: "216px" }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.8, delay: 0.3 }}
                        className="hidden lg:block h-[4px] bg-[#EA413C] absolute top-[166px] -left-[163px]"
                    />
                    <motion.h2
